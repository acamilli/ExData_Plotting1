...
#Plot 1
#hist(gap, main="Global Active Power", col="red", xlab="Global Active Power (kilowatts)", cex.main=0.8, cex.axis=0.6, cex.lab=0.6)
#Plot 2
#plot(dt,gap,type="l",ylab="Global Active Power (kilowatts)", xlab="", cex.axis=0.4, cex.lab=0.4)
#plot 3
